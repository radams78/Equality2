...
\begin{itemize}
\item
a type \ExecuteMetaData[Context.tex]{Cx}
\item
functions
...
\ExecuteMetaData[Syntax.tex]{Typing}
\end{itemize}
...
An earlier version of this system was presented in \cite{ap:tsnhu}.  It is closely related to the system PHOML (Predicative Higher-Order Minimal Logic) presented in \cite{abc:ncrpehoml}.  The system $\LEtwo$ can be seen as an extension of PHOML with groupoids, and with a univalent equality for both sets and groupoids.
